    ...
    if (icon != null) {
      return Row(
        ...
        children: [
          ...
          Text(text, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: contentColor)),
        ],
      );
    }

    return Text(text, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: contentColor));
  }
}
